<template>
  <div>
      ...
      <p class="mt-5">instagram clone is a minimal app that clone from instagram with nuxt universal framework, it help you to build vue js with the help of node js runtime environment</p>
